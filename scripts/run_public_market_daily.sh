...
mkdir -p logs "$RADAR_PUBLIC_MARKET_BASE_DIR/$RADAR_PUBLIC_MARKET_SLUG"
...
echo "hotel=$RADAR_PUBLIC_MARKET_HOTEL_NAME city=$RADAR_PUBLIC_MARKET_CITY start_date=$RADAR_PUBLIC_MARKET_START_DATE horizon_days=$RADAR_PUBLIC_MARKET_HORIZON_DAYS"
